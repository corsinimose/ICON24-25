...
class DiagnosticsES(KnowledgeEngine):
    ...
    def malattia_lieve(self):
        print("\nI sintomi indicano che potresti aver contratto il virus.")
    ...
    def malattia_grave(self):
        print("\nI sintomi indicano che potresti essere in uno stadio avanzato della malattia causata dal virus.")
    ...
    def malattia_assente(self):
        print("\nCon i sintomi indicati non dovresti aver contratto il virus.")
        self.reset()
